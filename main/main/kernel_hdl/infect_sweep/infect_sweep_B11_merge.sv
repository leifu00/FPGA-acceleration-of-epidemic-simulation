...
// SystemVerilog created from infect_sweep_B11_merge
...
module infect_sweep_B11_merge (
    ...
    output wire [31:0] out_i3_0185_2,
    ...
    wire [0:0] i3_0185_2_mux_s;
    reg [31:0] i3_0185_2_mux_q;
    ...
    // out_forked65(GPOUT,11)
    assign out_forked65 = forked65_mux_q;

    // i3_0185_2_mux(MUX,3)
    assign i3_0185_2_mux_s = in_valid_in_0;
    always @(i3_0185_2_mux_s or in_i3_0185_2_1 or in_i3_0185_2_0)
    begin
        unique case (i3_0185_2_mux_s)
            1'b0 : i3_0185_2_mux_q = in_i3_0185_2_1;
            1'b1 : i3_0185_2_mux_q = in_i3_0185_2_0;
            default : i3_0185_2_mux_q = 32'b0;
        endcase
    end

    // out_i3_0185_2(GPOUT,12)
    assign out_i3_0185_2 = i3_0185_2_mux_q;
