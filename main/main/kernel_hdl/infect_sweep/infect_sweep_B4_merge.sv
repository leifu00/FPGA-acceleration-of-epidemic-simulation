...
// SystemVerilog created from infect_sweep_B4_merge
...
module infect_sweep_B4_merge (
    ...
    wire [0:0] i3_0185_mux_s;
    reg [31:0] i3_0185_mux_q;
    ...
    // i3_0185_mux(MUX,3)
    assign i3_0185_mux_s = in_valid_in_0;
    always @(i3_0185_mux_s or in_i3_0185_1 or in_i3_0185_0)
    begin
        unique case (i3_0185_mux_s)
            1'b0 : i3_0185_mux_q = in_i3_0185_1;
            1'b1 : i3_0185_mux_q = in_i3_0185_0;
            default : i3_0185_mux_q = 32'b0;
        endcase
    end

    // out_i3_0185(GPOUT,12)
    assign out_i3_0185 = i3_0185_mux_q;
